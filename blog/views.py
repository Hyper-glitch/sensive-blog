...
from blog.blog_tools import get_related_posts_count, serialize_post, serialize_tag
from blog.models import Comment, Post, Tag


def index(request):
    posts = Post.objects.prefetch_related('author').annotate(likes_amount=Count('likes'))
